	...
	<div class="page-holder">
		...
		<div class="container">
			<section
				...
				style="background: url(shop-resources/img/hero-banner-alt.jpg)">
				...
				<div class="row">
					<div class="col-md-4 mb-4 mb-md-0">
						<a class="category-item" href="shop.html"><img
							class="img-fluid"
							src="${pageContext.request.contextPath}/shop-resources/img/cat-img-1.jpg"
							alt=""><strong class="category-item-title">Clothes</strong></a>
					</div>
					<div class="col-md-4 mb-4 mb-md-0">
						<a class="category-item mb-4" href="shop.html"><img
							class="img-fluid"
							src="${pageContext.request.contextPath}/shop-resources/img/cat-img-2.jpg"
							alt=""><strong class="category-item-title">Shoes</strong></a><a
							class="category-item" href="shop.html"><img class="img-fluid"
							src="${pageContext.request.contextPath}/shop-resources/img/cat-img-3.jpg"
							alt=""><strong class="category-item-title">Watches</strong></a>
					</div>
					<div class="col-md-4">
						<a class="category-item" href="shop.html"><img
							class="img-fluid"
							src="${pageContext.request.contextPath}/shop-resources/img/cat-img-4.jpg"
						...
						<div class="product text-center">
							<div class="position-relative mb-3">
								...
								<a class="d-block" href="detail.html"><img
									...
									src="${pageContext.request.contextPath}/shop-resources/img/product-1.jpg"
									alt="..."></a>
					...
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<div class="product text-center">
							<div class="position-relative mb-3">
								...
								<a class="d-block" href="detail.html"><img
									class="img-fluid w-100"
									src="${pageContext.request.contextPath}/shop-resources/img/product-2.jpg"
									alt="..."></a>
								<div class="product-overlay">
									<ul class="mb-0 list-inline">
										<li class="list-inline-item m-0 p-0"><a
					...
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<div class="product text-center">
							<div class="position-relative mb-3">
								...
								<a class="d-block" href="detail.html"><img
									class="img-fluid w-100"
									src="${pageContext.request.contextPath}/shop-resources/img/product-3.jpg"
									alt="..."></a>
								<div class="product-overlay">
									<ul class="mb-0 list-inline">
										<li class="list-inline-item m-0 p-0"><a
					...
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<div class="product text-center">
							<div class="position-relative mb-3">
								...
								<a class="d-block" href="detail.html"><img
									class="img-fluid w-100"
									src="${pageContext.request.contextPath}/shop-resources/img/product-4.jpg"
									alt="..."></a>
								<div class="product-overlay">
									<ul class="mb-0 list-inline">
										<li class="list-inline-item m-0 p-0"><a
					...
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<div class="product text-center">
							<div class="position-relative mb-3">
								...
								<a class="d-block" href="detail.html"><img
									class="img-fluid w-100"
									src="${pageContext.request.contextPath}/shop-resources/img/product-5.jpg"
									alt="..."></a>
								<div class="product-overlay">
									<ul class="mb-0 list-inline">
										<li class="list-inline-item m-0 p-0"><a
					...
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<div class="product text-center">
							<div class="position-relative mb-3">
								...
								<a class="d-block" href="detail.html"><img
									class="img-fluid w-100"
									src="${pageContext.request.contextPath}/shop-resources/img/product-6.jpg"
									alt="..."></a>
								<div class="product-overlay">
									<ul class="mb-0 list-inline">
										<li class="list-inline-item m-0 p-0"><a
					...
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<div class="product text-center">
							<div class="position-relative mb-3">
								...
								<a class="d-block" href="detail.html"><img
									class="img-fluid w-100"
									src="${pageContext.request.contextPath}/shop-resources/img/product-7.jpg"
									alt="..."></a>
								<div class="product-overlay">
									<ul class="mb-0 list-inline">
										<li class="list-inline-item m-0 p-0"><a
					...
					<div class="col-xl-3 col-lg-4 col-sm-6">
						<div class="product text-center">
							<div class="position-relative mb-3">
								...
								<a class="d-block" href="detail.html"><img
									class="img-fluid w-100"
									src="${pageContext.request.contextPath}/shop-resources/img/product-8.jpg"
									alt="..."></a>
								<div class="product-overlay">
									<ul class="mb-0 list-inline">
										<li class="list-inline-item m-0 p-0"><a
